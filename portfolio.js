...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Meghana.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">D.Meghana</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Meghana
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="MEGHANA.docx" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="meghana.jpg" alt="meghana"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Desu Meghana pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Electronics and Communiction Engineering.</span> I am passionate about knowing</p>
        ...
        <ul>
          <li>From - Rlykodur, India</li>
          <li>Lives in - Thurpupalli, India</li>
          <li>Age - 20</li>
          <li>Gender - Female</li>
        </ul>
      </section>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Dolphin Dale English Medium High School, RlyKodur</p>
          ...
          <div className="con rig">
            ...
            <div className="text-box">
              ...
              <p>I Completed my Intermediate Education at SriChaitanya Junior College, Tirupathi.</p>
              <p>I got 9.35 CGPA in my Intermediate Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 9.06 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 5/32A,<br /> Thurpupalli,<br /> Rlykodur,<br /> Annamayya(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="meghanareddy.desu@gmail.com">meghanareddy.desu@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 9182643598">9182643598</a></p>
            </div>
          </div>
